...
<div class="wrap rwd">
            ...
            {dynamic}
                <div class="login-bar row container">
                    <ul class="links right inline">
                        ...
                        {else}
                            <li class="liked">
                                 <a href="" title="" class="liked_link">
                                    <img src="/skins/user/rwd_shoper_1/images/heart.png" alt="" class="px0" >
                                    <span>ulubione</span>
                                </a>
                            </li>
                            {if $enable_register}
                            ...
                            <li class="login">
                                <a href="{route key='login'}" title="{translate key='Sign in'}" class="login">
                                    ...
                                    <img src="/skins/user/rwd_shoper_1/images/px1.jpg" alt="" class="px1" >
                                </a>
                            </li>
                        {/if}
                    </ul>
            ...
            {if 1 == $skin_settings->header->basket}
                {dynamic}
                    <div class="basket right{if 0 == $user->basket->countProducts()} empty-basket{/if}">
                        ...
                        <a class="settings">
                            <img src="/skins/user/rwd_shoper_1/images/settings.png" alt=""/>
                        </a>
                    </div>
    ...
    {if $boxes_header_side|@count > 0}
        <div class="top row">
            <div class="container">
                <div class="linkBox">
                    <div class="linkItem" style="background: url(/skins/user/rwd_shoper_1/images/banner1.jpg) center no-repeat;">
                        <a href=""> firany </a>
                    </div>
                    <div class="linkItem" style="background: url(/skins/user/rwd_shoper_1/images/banner2.jpg) center no-repeat;">
                        <a href=""> pościel </a>
                    </div>
                    <div class="linkItem" style="background: url(/skins/user/rwd_shoper_1/images/banner3.jpg) center no-repeat;">
                        <a href=""> ręczniki </a>
                    </div>
                </div>
            </div>
